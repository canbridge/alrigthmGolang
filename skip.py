...
# 源自： http://www.geeksforgeeks.org/skip-list-set-3-searching-deletion/
...
class SkipList(object):
    ...
    def insertElement(self, key):
        ...
        '''
        for i in range(self.level, -1, -1): # 从LEVEL到0
...
def main():
    ...
    lst.displayList()
    print (lst.header)
    for key in lst.header.attrs:
        print (getattr(key, lst.header))
main()
